    ...
    <div class="flow-root bg-gray-900 pb-16 pt-24 sm:pt-32 lg:pb-0">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="relative z-10">
          <h2 class="mx-auto max-w-4xl text-center text-5xl font-bold tracking-tight text-white">Affordability, without compromise</h2>
          <p class="mx-auto mt-4 max-w-2xl text-center text-lg leading-8 text-white/60">Our VPS platform lets you do more with more control, less service limitations, and tons of customizations to your hosting environment.</p>
        ...
        <div
          ...
          <div v-for="tier in tiers" :key="tier.id"
            ...
            <div class="p-8 lg:pt-12 xl:p-10 xl:pt-14">
              <h3 :id="tier.id"
                :class="[tier.featured ? 'text-gray-900' : 'text-white', 'text-sm font-semibold leading-6']">{{ tier.name
                }}</h3>
                      ...
                      <dl class="divide-y divide-gray-200 text-sm leading-6">
                        <div v-for="feature in section.features" :key="feature.name"
                          ...
                          <dd class="flex items-center justify-end sm:justify-center sm:px-4">
                            ...
                            <template v-else>
                              <CheckIcon v-if="feature.tiers[tier.name] === true" class="mx-auto h-5 w-5 text-indigo-600"
                                aria-hidden="true" />
